...
Blockly.Python['df_convert_column_to_type'] = function (block) {
    ...
    var code = `[${variable_data}] = md.df_convert_column_to_type(df=${value_df}, column_name=${value_column_name}, column_type=${value_column_type})\n`;
    return code;
};
...
Blockly.Python['excel_tabular_data_from_website'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_tabular_data_from_website(website_url=${value_website_url}, table_number=${value_table_number})\n`;
    return code;
};
...
Blockly.Python['df_from_list'] = function (block) {
    ...
    // TODO: Assemble Python into code variable.
    var code = `[${variable_df}] = md.df_from_list(list_of_lists=${value_list_of_lists}, column_names=${value_column_names})\n`;
    return code;
};
...
Blockly.Python['df_from_string'] = function (block) {
    ...
    var variable_df = Blockly.Python.nameDB_.getName(block.getFieldValue('df'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_df}] = md.df_from_string(df_string=${value_df_string}, word_delimeter=${value_word_delimeter}, line_delimeter=${value_line_delimeter}, column_names=${value_column_names})\n`;
    return code;
};
...
Blockly.Python['df_extract_sub_df'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.df_extract_sub_df(df=${value_df}, row_start=${value_row_start}, row_end=${value_row_end}, column_start=${value_column_start}, column_end=${value_column_end})\n`;
    return code;
};
...
Blockly.Python['set_value_in_df'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_status}] = md.set_value_in_df(df=${value_df}, row_number=${value_row_number}, column_number=${value_column_number}, value=${value_value})\n`;
    return code;
};
...
Blockly.Python['get_value_in_df'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.get_value_in_df(df=${value_df}, row_number=${value_row_number}, column_number=${value_column_number})\n`;
    return code;
};
...
Blockly.Python['df_extract_sub_df_v2'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_data}] = md.df_extract_sub_df(df=${value_df}, row_start=${value_row_start}, row_end=${value_row_end}, column_start=${value_column_start}, column_end=${value_column_end})\n`;
    return code;
};
...
Blockly.Python['set_value_in_df_v2'] = function (block) {
    ...
    // var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.set_value_in_df(df=${value_df}, row_number=${value_row_number}, column_number=${value_column_number}, value=${value_value})\n`;
    return code;
};
...
Blockly.Python['get_value_in_df_v2'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_data}] = md.get_value_in_df(df=${value_df}, row_number=${value_row_number}, column_number=${value_column_number})\n`;
    return code;
};
...
Blockly.Python['string_extract_substring'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.string_extract_substring(string=${value_string}, start_word=${value_start_word}, end_word=${value_end_word}, include_start_word=${capitalize(checkbox_include_start_word.toString())}, include_end_word=${capitalize(checkbox_include_end_word.toString())})\n`;
    return code;
};
...
Blockly.Python['date_time_now'] = function (block) {
    ...
    // TODO: Assemble Python into code variable.
    var code = `${variable_date} = md.date_time_now()\n`;
    return code;
};
...
Blockly.Python['add_datetime'] = function (block) {
    ...
    var variable_date = Blockly.Python.nameDB_.getName(block.getFieldValue('date'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `${variable_date} = md.add_datetime(input_date=${value_input_date}, time_type='${dropdown_time_type}', value=${value_value})\n`;
    return code;
};
...
Blockly.Python['subtract_datetime'] = function (block) {
    ...
    var variable_date = Blockly.Python.nameDB_.getName(block.getFieldValue('date'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `${variable_date} = md.subtract_datetime(input_date=${value_input_date}, time_type='${dropdown_time_type}', value=${value_value})\n`;
    return code;
};
...
Blockly.Python['excel_concat_all_sheets_of_given_excel'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_data}] = md.excel_concat_all_sheets_of_given_excel(excel_file_path=${value_excel_file_path}, sheet_names_as_list=${value_sheet_names_as_list})\n`;
    return code;
};
...
Blockly.Python['df_drop_rows'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_data}] = md.df_drop_rows(df=${value_df}, row_start=${value_row_start}, row_end=${value_row_end})\n`;
    return code;
};
...
Blockly.Python['df_vlookup'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_data}] = md.df_vlookup(df1=${value_df1}, df2=${value_df2}, column_name=${value_column_name}, how=${value_how})\n`;
    return code;
};
...
Blockly.Python['excel_get_single_cell_new_2'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_data}] = md.excel_get_single_cell(df=${value_df}, header=${value_header}, column_name=${value_column_name}, cell_number=${value_cell_number})\n`;
    return code;
};
...
Blockly.Python['excel_set_single_cell_new_2'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_data}] = md.excel_set_single_cell(df=${value_df}, column_name=${value_column_name}, cell_number=${value_cell_number}, text=${value_text})\n`;
    return code;
};
...
Blockly.Python['pdf_extract_all_tables'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.pdf_extract_all_tables(pdf_file_path=${value_pdf_file_path}, output_folder=${value_output_folder}, output_file_name=${value_output_file_name}, table_with_borders=${checkbox_table_with_borders})\n`;
    return code;
};
...
Blockly.Python['folder_delete_file_or_folder'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.folder_delete_file_or_folder(file_or_folder_path=${value_file_or_folder_path}, print_status=${capitalize(checkbox_print_status.toString())})\n`;
    return code;
};
...
Blockly.Python['pdf_extract_table'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status},${variable_data}] = md.pdf_extract_table(pdf_file_path=${value_pdf_file_path}, table_number=${value_table_number}, page_number=${value_page_number})\n`;
    return code;
};
