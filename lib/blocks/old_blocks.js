...
Blockly.Python['excel_get_single_cell_new'] = function (block) {
    ...
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_get_single_cell(df=${value_df}, header=${value_header}, column_name=${value_column_name}, cell_number=${value_cell_number})\n`;
    return code;
};
...
Blockly.Python['excel_set_single_cell_new'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_set_single_cell(df=${value_df}, column_name=${value_column_name}, cell_number=${value_cell_number}, text=${value_text})\n`;
    return code;
};
...
Blockly.Python['excel_get_single_cell'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_get_single_cell(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, header=${value_header}, column_name=${value_column_name}, cell_number=${value_cell_number})\n`;
    return code;
};
...
Blockly.Python['excel_set_single_cell'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_set_single_cell(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, header=${value_header}, column_name=${value_column_name}, cell_number=${value_cell_number}, text=${value_text})\n`;
    return code;
};