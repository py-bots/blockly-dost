...
Blockly.Python['authenticate_google_spreadsheet'] = function (block) {
    ...
    var code = `[${variable_status}, ${variable_data}] = md.authenticate_google_spreadsheet(credential_file_path=${value_credential_file_path})\n`;
    return code;
};
...
Blockly.Python['excel_get_dataframe_from_google_spreadsheet'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_get_dataframe_from_google_spreadsheet(auth=${value_auth}, spreadsheet_url=${value_spreadsheet_url}, sheet_name=${value_sheet_name})\n`;
    return code;
};
...
Blockly.Python['excel_upload_dataframe_to_google_spreadsheet'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_upload_dataframe_to_google_spreadsheet(auth=${value_auth}, spreadsheet_url=${value_spreadsheet_url}, sheet_name=${value_sheet_name}, df=${value_df})\n`;
    return code;
};

Blockly.Python['art_simple_effects'] = function (block) {
    Blockly.Python.definitions_["my_dost"] = "import my_dost as md";
    ...
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.art_simple_effects(user_input_img_path=${value_user_input_img_path}, name_required_on_image=${value_name_required_on_image}, output_folder=${value_output_folder})\n`;
    return code;
};
...
Blockly.Python['art_neural_effects'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.art_neural_effects(input_image_folder_path=${value_input_image_folder_path}, style_image_folder_path=${value_style_image_folder_path}, output_image_folder_path=${value_output_image_folder_path})\n`;
    return code;
};
...
Blockly.Python['ar_facecam'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.ar_facecam(left_eye_image=${value_left_eye_image}, right_eye_image=${value_right_eye_image}, mouth_animation=${value_mouth_animation})\n`;
    return code;
};
...
Blockly.Python['ar_trackhands'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.ar_trackhands()\n`;
    return code;
};
...
Blockly.Python['ar_facemesh'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.ar_facemesh()\n`;
    return code;
};
...
Blockly.Python['convert_change_corrupt_xls_to_xlsx'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.convert_change_corrupt_xls_to_xlsx(input_file=${value_input_file}, input_sheetname=${value_input_sheetname}, output_folder=${value_output_folder}, output_filename=${value_output_filename})\n`;
    return code;
};
...
Blockly.Python['convert_xls_to_xlsx'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.convert_xls_to_xlsx(input_file=${value_input_file}, output_folder=${value_output_folder}, output_filename=${value_output_filename})\n`;
    return code;
};
...
Blockly.Python['convert_image_to_base64'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.convert_image_to_base64(input_file=${value_input_file})\n`;
    return code;
};
...
Blockly.Python['convert_base64_to_img'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.convert_base64_to_img(imgBase64Str=${value_imgbase64str}, img_folder_path=${value_img_folder_path}, img_file_name=${value_img_file_name})\n`;
    return code;
};
...
Blockly.Python['convert_csv_to_excel'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.convert_csv_to_excel(csv_path=${value_csv_path}, sep=${value_sep}, excel_output_folder_path=${value_excel_output_folder_path}, excel_file_name=${value_excel_file_name})\n`;
    return code;
};
...
Blockly.Python['convert_jpg_to_png'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.convert_jpg_to_png(input_filepath=${value_input_filepath}, output_folder=${value_output_folder}, output_filename=${value_output_filename})\n`;
    return code;
};
...
Blockly.Python['convert_png_to_jpg'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.convert_png_to_jpg(input_filepath=${value_input_filepath}, output_folder=${value_output_folder}, output_filename=${value_output_filename})\n`;
    return code;
};
...
Blockly.Python['convert_excel_to_colored_html'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.convert_excel_to_colored_html(input_filepath=${value_input_filepath}, output_folder=${value_output_folder}, output_filename=${value_output_filename})\n`;
    return code;
};
...
Blockly.Python['ds_html_table_from_website'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.ds_html_table_from_website(website_url=${value_website_url}, output_folder=${value_output_folder})\n`;
    return code;
};
...
Blockly.Python['ds_pivot_excel_table'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.ds_pivot_excel_table(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, header=${value_header}, rows=${value_rows}, cols=${value_cols})\n`;
    return code;
};
...
Blockly.Python['ds_describe_excel_data'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.ds_describe_excel_data(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, header=${value_header})\n`;
    return code;
};
...
Blockly.Python['ds_draw_charts_from_excel'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.ds_draw_charts_from_excel(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, header=${value_header}, x_col=${value_x_col}, y_col=${value_y_col}, title=${value_title}, chart_type='${dropdown_chart_type}')\n`;
    return code;
};
...
Blockly.Python['excel_copy_range_from_sheet'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_copy_range_from_sheet(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, start_col=${value_start_col}, start_row=${value_start_row}, end_col=${value_end_col}, end_row=${value_end_row})\n`;
    return code;
};
...
Blockly.Python['excel_paste_range_to_sheet'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_paste_range_to_sheet(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, start_col=${value_start_col}, start_row=${value_start_row}, copied_data=${value_copied_data})\n`;
    return code;
};
...
Blockly.Python['excel_get_all_header_columns'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_get_all_header_columns(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, header=${value_header})\n`;
    return code;
};
...
Blockly.Python['excel_get_row_column_count'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_get_row_column_count(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, header=${value_header})\n`;
    return code;
};
...
Blockly.Python['excel_get_all_sheet_names'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_get_all_sheet_names(input_filepath=${value_input_filepath})\n`;
    return code;
};
...
Blockly.Python['excel_clear_sheet'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_clear_sheet(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, header=${value_header})\n`;
    return code;
};
...
Blockly.Python['excel_drop_columns'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_drop_columns(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, header=${value_header}, cols=${value_cols})\n`;
    return code;
};
...
Blockly.Python['excel_remove_duplicates'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_remove_duplicates(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, header=${value_header}, column_name=${value_column_name}, output_folder=${value_output_folder}, output_filename=${value_output_filename}, same_file=${capitalize(checkbox_same_file.toString())})\n`;
    return code;
};
...
Blockly.Python['excel_group_by_column_values_n_split'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_group_by_column_values_n_split(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, header=${value_header}, column_name=${value_column_name}, output_folder=${value_output_folder}, output_filename=${value_output_filename})\n`;
    return code;
};
...
Blockly.Python['excel_if_value_exists'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_if_value_exists(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, header=${value_header}, cols=${value_cols}, value=${value_value})\n`;
    return code;
};
...
Blockly.Python['excel_apply_format_as_table'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_apply_format_as_table(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname})\n`;
    return code;
};
...
Blockly.Python['excel_merge_all_files'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_merge_all_files(input_filepath=${value_input_filepath}, output_folder=${value_output_folder}, output_filename=${value_output_filename})\n`;
    return code;
};
...
Blockly.Python['excel_create_file'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_create_file(output_sheetname=${value_output_sheetname}, output_folder=${value_output_folder}, output_filename=${value_output_filename})\n`;
    return code;
};
...
Blockly.Python['pause_program'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.pause_program(seconds=${value_seconds})\n`;
    return code;
};
...
Blockly.Python['text_to_speech'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.text_to_speech(audio=${value_audio}, show=${capitalize(checkbox_show.toString())})\n`;
    return code;
};
...
Blockly.Python['speech_to_text'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.speech_to_text()\n`;
    return code;
};
...
Blockly.Python['image_to_text'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.image_to_text(img_path=${value_img_path})\n`;
    return code;
};
...
Blockly.Python['api_request'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.api_request(url=${value_url}, headers=${value_headers}, body=${value_body}, method='${dropdown_method}')\n`;
    return code;
};
...
Blockly.Python['folder_write_text_file'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.folder_write_text_file(txt_file_path = ${value_txt_file_path}, contents = ${value_contents})\n`;
    return code;
};
...
Blockly.Python['folder_create'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.folder_create(strFolderPath = ${value_strfolderpath})\n`;
    return code;
};
...
Blockly.Python['folder_create_text_file'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.folder_create_text_file(textFolderPath = ${value_textfolderpath}, txtFileName = ${value_txtfilename})\n`;
    return code;
};
...
Blockly.Python['folder_delete_all_files'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.folder_delete_all_files(fullPathOfTheFolder = ${value_fullpathofthefolder}, file_extension_without_dot = ${value_file_extension_without_dot}, print_status = ${capitalize(checkbox_print_status.toString())})\n`;
    return code;
};
...
Blockly.Python['file_rename'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.file_rename(old_file_path = ${value_old_file_path}, new_file_name = ${value_new_file_name}, print_status = ${capitalize(checkbox_print_status.toString())})\n`;
    return code;
};
...
Blockly.Python['folder_get_all_filenames_as_list'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.folder_get_all_filenames_as_list(strFolderPath = ${value_strfolderpath}, extension = ${value_extension})\n`;
    return code;
};
...
Blockly.Python['folder_read_text_file'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.folder_read_text_file(txt_file_path = ${value_txt_file_path})\n`;
    return code;
};
...
Blockly.Python['file_get_json_details'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.file_get_json_details(path_of_json_file = ${value_path_of_json_file}, section = ${value_section})\n`;
    return code;
};
...
Blockly.Python['key_press'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.key_press(key_1 = ${dropdown_key_1}, key_2 = ${dropdown_key_2}, key_3 = ${dropdown_key_3}, write_to_window = ${value_write_to_window})\n`;
    return code;
};
...
Blockly.Python['key_write_enter'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.key_write_enter(text_to_write = ${value_text_to_write}, write_to_window = ${value_write_to_window}, key = "${dropdown_key}")\n`;
    return code;
};
...
Blockly.Python['key_hit_enter'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.key_hit_enter(write_to_window = ${value_write_to_window})\n`;
    return code;
};
...
Blockly.Python['mail_send_via_desktop_outlook'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.mail_send_via_desktop_outlook(to_email_id=${value_to_email_id}, subject=${value_subject}, message=${value_message}, attachment_path=${value_attachment_path})\n`;
    return code;
};
...
Blockly.Python['mail_send_gmail_with_app_password'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.mail_send_gmail_with_app_password(gmail_username=${value_gmail_username}, gmail_app_password=${value_gmail_app_password}, to_email_id=${value_to_email_id}, subject=${value_subject}, message=${value_message}, attachment_path=${value_attachment_path})\n`;
    return code;
};
...
Blockly.Python['msg_box_info'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.msg_box_info(msg_for_user=${value_msg_for_user})\n`;
    return code;
};
...
Blockly.Python['msg_box_ask_yes_no'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.msg_box_ask_yes_no(msg_for_user=${value_msg_for_user})\n`;
    return code;
};
...
Blockly.Python['msg_count_down'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.msg_count_down(msg_for_user=${value_msg_for_user}, default_time=${value_default_time})\n`;
    return code;
};
...
Blockly.Python['mouse_click'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.mouse_click(x=${value_x}, y=${value_y}, no_of_clicks=${value_no_of_clicks}, left_or_right='${dropdown_left_or_right}', type_of_movement='${dropdown_type_of_movement}')\n`;
    return code;
};
...
Blockly.Python['mouse_move'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.mouse_move(x=${value_x}, y=${value_y}, type_of_movement='${dropdown_type_of_movement}')\n`;
    return code;
};
...
Blockly.Python['mouse_drag_from_to'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.mouse_drag_from_to(x1=${value_x1}, y1=${value_y1}, x2=${value_x2}, y2=${value_y2})\n`;
    return code;
};
...
Blockly.Python['mouse_search_snip_return_coordinates_x_y'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.mouse_search_snip_return_coordinates_x_y(img=${value_img}, wait=${value_wait})\n`;
    return code;
};
...
Blockly.Python['pdf_extract_all_tables'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.pdf_extract_all_tables(pdf_file_path=${value_pdf_file_path}, output_folder=${value_output_folder}, output_file_name=${value_output_file_name})\n`;
    return code;
};
...
Blockly.Python['citrix_scrape_contents_by_search_copy_paste'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.citrix_scrape_contents_by_search_copy_paste(highlight_text=${value_highlight_text})\n`;
    return code;
};
...
Blockly.Python['citrix_window_clear_search'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.citrix_window_clear_search()\n`;
    return code;
};
...
Blockly.Python['clipboard_get_data'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.clipboard_get_data()\n`;
    return code;
};
...
Blockly.Python['clipboard_set_data'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.clipboard_set_data(data=${value_data})\n`;
    return code;
};
...
Blockly.Python['screen_clear_search'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.screen_clear_search(delay = ${value_delay})\n`;
    return code;
};
...
Blockly.Python['scrape_save_contents_to_notepad'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.scrape_save_contents_to_notepad(folderPathToSaveTheNotepad = ${value_folderpathtosavethenotepad}, switch_to_window = ${value_switch_to_window})\n`;
    return code;
};
...
Blockly.Python['string_extract_only_alphabets'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.string_extract_only_alphabets(inputString = ${value_inputstring})\n`;
    return code;
};
...
Blockly.Python['string_extract_only_numbers'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.string_extract_only_numbers(inputString = ${value_inputstring})\n`;
    return code;
};
...
Blockly.Python['string_remove_special_characters'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.string_remove_special_characters(inputStr = ${value_inputstr})\n`;
    return code;
};
...
Blockly.Python['windows_show_desktop'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.windows_show_desktop()\n`;
    return code;
};
...
Blockly.Python['windows_launch_app'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.windows_launch_app(pathOfExeFile = ${value_pathofexefile})\n`;
    return code;
};
...
Blockly.Python['window_restore_windows'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.window_restore_windows(windowName = ${value_windowname})\n`;
    return code;
};

Blockly.Python['window_maximize_windows'] = function (block) {
    Blockly.Python.definitions_["my_dost"] = "import my_dost as md";
    var value_windowname = Blockly.Python.valueToCode(block, 'windowName', Blockly.Python.ORDER_ATOMIC);
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.window_maximize_windows(windowName = ${value_windowname})\n`;
    return code;
};
...
Blockly.Python['window_minimize_windows'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.window_minimize_windows(windowName = ${value_windowname})\n`;
    return code;
};
...
Blockly.Python['window_close_windows'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.window_close_windows(windowName = ${value_windowname})\n`;
    return code;
};
...
Blockly.Python['window_get_all_opened_titles_windows'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.window_get_all_opened_titles_windows()\n`;
    return code;
};
...
Blockly.Python['window_get_active_window'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.window_get_active_window()\n`;
    return code;
};
...
Blockly.Python['window_activate_window'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.window_activate_window(window_title = ${value_window_title})\n`;
    return code;
};