...
Blockly.Python['excel_get_all_header_columns_new'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_get_all_header_columns(df=${value_df})\n`;
    return code;
};
...
Blockly.Python['excel_get_row_column_count_new'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_get_row_column_count(df=${value_df})\n`;
    return code;
};
...
Blockly.Python['excel_clear_sheet_new'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_clear_sheet(df=${value_df})\n`;
    return code;
};
...
Blockly.Python['excel_drop_columns_new'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_drop_columns(df=${value_df}, cols=${value_cols})\n`;
    return code;
};
...
Blockly.Python['excel_remove_duplicates_new'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_remove_duplicates(df=${value_df}, column_name=${value_column_name})\n`;
    return code;
};
...
Blockly.Python['excel_group_by_column_values_n_split_new'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_group_by_column_values_n_split(df=${value_df}, column_name=${value_column_name}, output_folder=${value_output_folder}, output_filename=${value_output_filename})\n`;
    return code;
};
...
Blockly.Python['excel_if_value_exists_new'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_if_value_exists(df=${value_df}, cols=${value_cols}, value=${value_value})\n`;
    return code;
};
...
Blockly.Python['excel_merge_all_files_new'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.excel_merge_all_files(input_folder_path=${value_input_filepath}, output_folder=${value_output_folder}, output_filename=${value_output_filename})\n`;
    return code;
};
...
Blockly.Python['dataframe_to_excel_new'] = function (block) {
    ...
    var variable_status = Blockly.Python.nameDB_.getName(block.getFieldValue('status'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}] = md.dataframe_to_excel(df=${value_df}, output_sheetname=${value_output_sheetname}, output_folder=${value_output_folder}, output_filename=${value_output_filename}, mode='${value_mode}')\n`;
    return code;
};
...
Blockly.Python['excel_to_dataframe_new'] = function (block) {
    ...
    var variable_data = Blockly.Python.nameDB_.getName(block.getFieldValue('data'), 'VARIABLE');
    // TODO: Assemble Python into code variable.
    var code = `[${variable_status}, ${variable_data}] = md.excel_to_dataframe(input_filepath=${value_input_filepath}, input_sheetname=${value_input_sheetname}, header=${value_header})\n`;
    return code;
};
